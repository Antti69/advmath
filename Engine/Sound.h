...
private:
	...
	private:
		HMODULE hModule = 0;
		static constexpr auto* systemPath = L"XAudio2_7.dll";
#ifdef _M_X64			 
		static constexpr auto* folderPath = L"XAudio\\XAudio2_7_64.dll";
		static constexpr auto* localPath = L"XAudio2_7_64.dll";
#else					 
		static constexpr auto* folderPath = L"XAudio\\XAudio2_7_32.dll";
		static constexpr auto* localPath = L"XAudio2_7_32.dll";
#endif
	};
public:
	class Channel
